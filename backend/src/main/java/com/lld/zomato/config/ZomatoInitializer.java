...
public class ZomatoInitializer implements CommandLineRunner {
    ...
    public static void seed(ZomatoRepository repo) {
        // --- 1. Customers ---
        ...
        repo.saveDeliveryAgent(a1);
        repo.saveDeliveryAgent(a2);
        repo.saveDeliveryAgent(a3);
        ...
        Restaurant r1 = new Restaurant("REST-01", "Spice Garden", "Indiranagar, Bangalore", "North Indian, Mughlai", 4.7, true, menu1);
        ...
        Restaurant r2 = new Restaurant("REST-02", "Burger House", "Koramangala 5th Block, Bangalore", "American, Fast Food", 4.5, true, menu2);
        ...
        Restaurant r3 = new Restaurant("REST-03", "Pizza Paradise", "HSR Layout Sector 1, Bangalore", "Italian, Pizza", 4.8, true, menu3);
        ...
        Restaurant r4 = new Restaurant("REST-04", "Sushi Express", "UB City, Vittal Mallya Road, Bangalore", "Japanese, Asian", 4.9, true, menu4);

        repo.saveRestaurant(r1);
        repo.saveRestaurant(r2);
        repo.saveRestaurant(r3);
        repo.saveRestaurant(r4);
        ...
        repo.saveOrder(seedOrder);

        repo.saveNotification(new Notification("N-01", "CUSTOMER", c1.getId(), orderId, "Agent Ramesh Kumar is on the way with your order!"));
        repo.saveNotification(new Notification("N-02", "RESTAURANT", r1.getId(), orderId, "Order REST-01 dispatched with Ramesh Kumar."));
    }
}
