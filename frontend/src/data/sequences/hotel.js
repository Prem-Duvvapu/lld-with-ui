  ...
  flows: [
    {
      ...
      steps: [
        ...
        { from: 'service', to: 'factory', text: '[Alice] resolve(checkIn: Dec 20, checkOut: Dec 25) — stay includes a Friday/Saturday night', activate: 'factory' },
        { from: 'factory', to: 'service', text: '[Alice] return WeekendTariffStrategy', type: 'return', deactivate: 'factory' },
        { from: 'service', to: 'service', text: '[Alice] totalAmount = strategy.calculateTariff(room, checkIn, checkOut)' },
