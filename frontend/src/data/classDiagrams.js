const classDiagrams = {
  ...
  loggingFramework: {
    ...
    classes: [
      { name: 'Logger', stereotype: 'entity', fields: ['- name: String', '- level: LogLevel', '- parent: Logger', '- appenders: List<LogAppender>'], methods: ['+ log(level, msg, ctx): LogMessage', '+ info(msg): LogMessage', '+ error(msg): LogMessage'] },
      ...
      { name: 'LogHandler', stereotype: 'abstract', fields: ['# level: LogLevel', '# nextHandler: LogHandler'], methods: ['+ handle(msg, appenders, formatter): boolean', '+ setNext(nextHandler): LogHandler'] },
      { name: 'LogAppender', stereotype: 'interface', fields: [], methods: ['+ append(message, formatter): void', '+ getStatus(): AppenderStatus'] },
      { name: 'ConsoleAppender', fields: ['- name: String', '- enabled: boolean'], methods: ['+ append(message, formatter): void'] },
      { name: 'FileAppender', fields: ['- filePath: String', '- maxBytes: long', '- rotatedFiles: List'], methods: ['+ append(message, formatter): void', '- rotate(): void'] },
      ...
      { name: 'LogFormatter', stereotype: 'interface', fields: [], methods: ['+ format(message): String'] },
      { name: 'AsyncLogDispatcher', stereotype: 'worker', fields: ['- queue: BlockingQueue', '- droppedCount: AtomicLong'], methods: ['+ dispatch(msg, appenders, formatter): boolean'] },
    ],
    relationships: [
